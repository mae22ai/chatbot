...
from .llm_client import analyze_school_grammar, detect_grammatical_issue, analyze_sino_korean
    ...
    try:
        ...
        try:
            ...
            detected_issues_str = detect_grammatical_issue(
                analysis_markdown=main_md, # result_md -> main_md
